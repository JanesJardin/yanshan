...
import com.wangdakeji.wongder.common.constant.Dict;
import com.wangdakeji.wongder.common.constant.cache.Cache;
...
import com.wangdakeji.wongder.common.persistence.dao.UserMapper;
import com.wangdakeji.wongder.common.persistence.model.Role;
...
import com.wangdakeji.wongder.core.base.tips.Tip;
import com.wangdakeji.wongder.core.cache.CacheKit;
import com.wangdakeji.wongder.core.datascope.DataScope;
import com.wangdakeji.wongder.core.log.LogObjectHolder;
...
import com.wangdakeji.wongder.modular.system.warpper.RoleWarpper;
...
public class RoleController extends BaseController {
    ...
    public Object list(@RequestParam(required = false) String roleName) {
        if (ShiroKit.isAdmin()) {
            List<Map<String, Object>> roles = this.roleDao.selectRoles(null,super.getPara("roleName"));
            return super.warpObject(new RoleWarpper(roles));
        } else {
            DataScope dataScope = new DataScope(ShiroKit.getRoleDataScope());
            dataScope.setScopeName("pid");
            List<Map<String, Object>> roles = this.roleDao.selectRoles(dataScope, super.getPara("roleName"));
            return super.warpObject(new RoleWarpper(roles));
        }
    }
