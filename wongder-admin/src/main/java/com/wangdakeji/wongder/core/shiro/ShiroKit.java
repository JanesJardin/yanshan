...
public class ShiroKit {
     ...
     * @return
     */
    public static List<Integer> getRoleDataScope() {
        List<Integer> roleIds = getUser().roleList;
        List<Integer> subRoleIds = ConstantFactory.me().getSubRoleIds(roleIds);
        subRoleIds.addAll(roleIds);
        return subRoleIds;
    }
}
