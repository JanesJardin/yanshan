...
DeptInfoDlg.addSubmit = function() {
    ...
    //提交信息
    var ajax = new $ax(Wongder.ctxPath + "/dept/add", function(data){
...
DeptInfoDlg.editSubmit = function() {
    ...
    //提交信息
    var ajax = new $ax(Wongder.ctxPath + "/dept/update", function(data){
...
$(function() {
    Wongder.initValidator("deptInfoForm", DeptInfoDlg.validateFields);
