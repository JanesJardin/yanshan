...
RolInfoDlg.showDeptSelectTree = function () {
    Wongder.showInputTree("deptName", "deptContent");
};
...
RolInfoDlg.showPNameSelectTree = function () {
    Wongder.showInputTree("pName", "pNameContent");
};
...
RolInfoDlg.addSubmit = function () {
    ...
    //提交信息
    var ajax = new $ax(Wongder.ctxPath + "/role/add", function (data) {
...
RolInfoDlg.editSubmit = function () {
    ...
    //提交信息
    var ajax = new $ax(Wongder.ctxPath + "/role/edit", function (data) {
...
$(function () {
    Wongder.initValidator("roleInfoForm", RolInfoDlg.validateFields);
