...
UserInfoDlg.addSubmit = function () {
    ...
    if (!this.validatePwd()) {
        Wongder.error("两次密码输入不一致");
        return;
    }

    //提交信息
    var ajax = new $ax(Wongder.ctxPath + "/mgr/add", function (data) {
...
UserInfoDlg.editSubmit = function () {
    ...
    //提交信息
    var ajax = new $ax(Wongder.ctxPath + "/mgr/edit", function (data) {
...
UserInfoDlg.chPwd = function () {
    var ajax = new $ax(Wongder.ctxPath + "/mgr/changePwd", function (data) {
        Wongder.success("修改成功!");
    }, function (data) {
        Wongder.error("修改失败!" + data.responseJSON.message + "!");
    });
...
$(function () {
    Wongder.initValidator("userInfoForm", UserInfoDlg.validateFields);
