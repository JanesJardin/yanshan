...
NoticeInfoDlg.addSubmit = function () {
    ...
    //提交信息
    var ajax = new $ax(Wongder.ctxPath + "/notice/add", function (data) {
...
NoticeInfoDlg.editSubmit = function () {
    ...
    //提交信息
    var ajax = new $ax(Wongder.ctxPath + "/notice/update", function (data) {
...
$(function () {
    Wongder.initValidator("noticeInfoForm", NoticeInfoDlg.validateFields);
