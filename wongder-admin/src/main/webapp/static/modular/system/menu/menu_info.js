...
MenuInfoDlg.addSubmit = function () {
    ...
    //提交信息
    var ajax = new $ax(Wongder.ctxPath + "/menu/add", function (data) {
...
MenuInfoDlg.editSubmit = function () {
    ...
    //提交信息
    var ajax = new $ax(Wongder.ctxPath + "/menu/edit", function (data) {
...
MenuInfoDlg.showMenuSelectTree = function () {
    Wongder.showInputTree("pcodeName", "pcodeTreeDiv", 15, 34);
};

$(function () {
    Wongder.initValidator("menuInfoForm", MenuInfoDlg.validateFields);
