package com.wangdakeji.wongder.core.mutidatasource.aop;

import com.wangdakeji.wongder.core.mutidatasource.DataSourceContextHolder;
...
public class MultiSourceExAop implements Ordered {
    ...
    @Pointcut(value = "@annotation(com.wangdakeji.wongder.core.mutidatasource.annotion.DataSource)")
    private void cut() {
